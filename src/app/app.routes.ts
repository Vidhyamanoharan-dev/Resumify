...
export const routes: Routes = [
  ...
  { path: 'upload',loadComponent: () => import('./browseresume/browseresume.component').then(m => m.BrowseResumeComponent),canActivate: [AuthGuard]},
  { path: 'enhance', component: ResumeEnhancingComponent },
  { path: 'parsedresumes',loadComponent: () => import('./parsedresume/parsedresume.component').then(m => m.ParsedresumeComponent),canActivate: [AuthGuard]},
  ...
  { path: 'help',loadComponent: () =>import('./footer-pages/help/help.component').then(m => m.HelpComponent)},
  { path: 'contact',loadComponent: () =>import('./footer-pages/contactus/contactus.component').then(m => m.ContactusComponent)},
  { path: 'privacy-policy',loadComponent: () =>import('./footer-pages/privacypolicy/privacypolicy.component').then(m => m.PrivacypolicyComponent)},
  { path: 'terms-of-service',loadComponent: () =>import('./footer-pages/termsofservice/termsofservice.component').then(m => m.TermsofserviceComponent)},
  { path: 'gdpr-ccpa',loadComponent: () =>import('./footer-pages/gdrp-ccpa/gdrp-ccpa.component').then(m => m.GDRPCCPAComponent)},
